...
<!-- Home -->
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="assets/images/assets/menu.jpg" data-speed="0.8"></div>
		...
		<div class="container">
			...
			<div class="row themenu_row">
				...
				<div class="col-lg-4 themenu_column">
					<div class="themenu_image"><img src="assets/images/assets/starters.jpg" alt=""></div>
				...
				<!-- Main -->
				<div class="col-lg-4 themenu_column">
					<div class="themenu_image"><img src="assets/images/assets/main.jpg" alt=""></div>
					<div class="themenu_col trans_400">
				...
				<!-- Deserts -->
				<div class="col-lg-4 themenu_column">
					<div class="themenu_image"><img src="assets/images/assets/deserts.jpg" alt=""></div>
					<div class="themenu_col trans_400">
				...
				<div class="col">
					...
					<div class="sig_dish">
						<div class="row row-eq-height">
							...
							<div class="col-lg-6 sig_col">
								<div class="sig_image"><img src="assets/images/assets/sig_1.jpg" alt=""></div>
							</div>
						</div>
					</div>
					...
					<div class="sig_dish">
						<div class="row row-eq-height">
							...
							<div class="col-lg-6 sig_col">
								<div class="sig_image"><img src="assets/images/assets/sig_2.jpg" alt=""></div>
							</div>
						</div>
					</div>
					...
					<div class="sig_dish">
						<div class="row row-eq-height">
							...
							<div class="col-lg-6 sig_col">
								<div class="sig_image"><img src="assets/images/assets/sig_3.jpg" alt=""></div>
							</div>
						</div>
					</div>
